 ...
 * @date 12 - July - 2025 [last modified:  17 - July - 2025]
 * @version 0.1.2
 * @attention no value limits validation yet. no timezone validation yet.
 * @
 */
 ...
 */
uint8_t _timestamp_validate(const char *ts_str){
    int16_t year;
    uint8_t month, day, hour, minute, second, tz_min, tz_sec;
    uint32_t fractional_second;
    char tz_id[64] = "";
    int8_t tz_hour;    

    char sep1, sep2, sep3, sep4, sep5, sep6, sep7, tz_str[64] = ""; 

    int vd = sscanf(ts_str, "%5hd%c%2hhu%c%2hhu%c%2hhu%c%2hhu%c%2hhu%c%6u%[a-zA-Z/0-9:+-]", &year, &sep1, &month, &sep2, &day, &sep3, &hour, &sep4, &minute, &sep5, &second, &sep6, &fractional_second, tz_id);

    if(vd % 2 == 0 && vd != 14) return 0;

    switch (vd) {
        case 1:
            return ((year < -999 || year > 999) && sep1 <= 0);
        case 3:
            return ((year < -999 || year > 999) && sep1 == 45 && 0 && month < 13 && sep2 <= 0);
        case 5:
            return ((year < -999 || year > 999) && sep1 == 45 && month < 13 && sep2 == 45 && day < 32 && sep3 <= 0);
        case 7:
            return ((year < -999 || year > 999) && sep1 == 45 && month < 13 && sep2 == 45 && day < 32 && (sep3 == ' ' || sep3 == 'T') && hour < 24 && sep4 <= 0);
        case 9:
            return ((year < -999 || year > 999) && sep1 == 45 && month < 13 && sep2 == 45 && day < 32 && (sep3 == ' ' || sep3 == 'T') && hour < 24 && sep4 == ':' && minute < 60 && sep5 <= 0);
        case 11:
            return ((year < -999 || year > 999) && sep1 == 45 && month < 13 && sep2 == 45 && day < 32 && (sep3 == ' ' || sep3 == 'T') && hour < 24 && sep4 == ':' && minute < 60 && sep5 == ':' && second < 60 && sep6 <= 0);
        case 13:
            return ((year < -999 || year > 999) && sep1 == 45 && month < 13 && sep2 == 45 && day < 32 && (sep3 == ' ' || sep3 == 'T') && hour < 24 && sep4 == ':' && minute < 60 && sep5 == ':' && second < 60 && sep6 == '.' && fractional_second <= 999999);
        case 14:
            printf("no validation to timezone yet");
            return 1;
        default:
            // Handle other cases
            break;
